 ...
 * @author wahyu
 */
public class backtologin extends javax.swing.JDialog {
    
    private boolean isClose = false;
    /**
     * Creates new form backtologin
     */
    public backtologin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(tidak, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 100, 90, 30));
        ...
        getContentPane().add(ya, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 90, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/popup/Popup Ke login.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(backtologin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                backtologin dialog = new backtologin(new javax.swing.JFrame(), true);
