...
//   
    ...
    public void dataTable() {
        Object[] Baris = {"No", "Tanggal", "ID LOG MASUK", "TOTAL HARGA KESELURUHAN"};
    ...
    public void HeaderColumn1() {
        ...
        centerRenderer.setHorizontalAlignment(JLabel.CENTER);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tbl_logmasuk.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        tbl_logmasuk.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
        tbl_logmasuk.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
        tbl_logmasuk.getColumnModel().getColumn(3).setCellRenderer(centerRenderer);
        tbl_logmasuk.getColumnModel().getColumn(5).setCellRenderer(centerRenderer);
        tbl_logmasuk.getColumnModel().getColumn(7).setCellRenderer(centerRenderer);
        tbl_logmasuk.getColumnModel().getColumn(8).setCellRenderer(centerRenderer);
        tbl_logmasuk.getColumnModel().getColumn(9).setCellRenderer(centerRenderer);

        ((DefaultTableCellRenderer) tbl_logmasuk.getTableHeader().getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);

        JTableHeader thead = tbl_logmasuk.getTableHeader();
        thead.setForeground(Color.BLACK);
        thead.setFont(new Font("Tahome", Font.BOLD, 12));

        TableColumn column;
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(0);
        column.setPreferredWidth(30);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(1);
        column.setPreferredWidth(84);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(2);
        column.setPreferredWidth(86);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(3);
        column.setPreferredWidth(71);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(4);
        column.setPreferredWidth(148);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(5);
        column.setPreferredWidth(68);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(6);
        column.setPreferredWidth(172);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(7);
        column.setPreferredWidth(53);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(8);
        column.setPreferredWidth(74);
        tbl_logmasuk.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_logmasuk.getColumnModel().getColumn(9);
        column.setPreferredWidth(60);
    }

    public void tbl_logmasuk1() {

        this.tbl_logmasuk.setModel(new javax.swing.table.DefaultTableModel(
                null,
                new String[]{
                    "No", "Tanggal", "ID Log Masuk", "ID Supplier", "Nama Supplier", "ID Produk", "Nama Produk", "Jumlah", "Harga Beli", "Total"
        ...
        DefaultTableModel tbl = (DefaultTableModel) this.tbl_logmasuk.getModel();

        tbl_logmasuk.setModel(tbl);

        try {

            int no = 1;

            String sql = "SELECT log_produkmasuk.Tanggal,detail_logprodukmasuk.Id_Logmasuk, detail_logprodukmasuk.Id_Supplier,detail_logprodukmasuk.Nama_Supplier,detail_logprodukmasuk.Id_Produk,detail_logprodukmasuk.Nama_Produk,detail_logprodukmasuk.jumlah,detail_logprodukmasuk.Harga_Beli,detail_logprodukmasuk.total FROM log_produkmasuk JOIN detail_logprodukmasuk ON detail_logprodukmasuk.Id_Logmasuk = log_produkmasuk.Id_Logmasuk ";
            java.sql.Connection conn = (Connection) config.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()) {
                tbl.addRow(new Object[]{no++, res.getString(1), res.getString(2), res.getString(3), res.getString(4), res.getString(5), res.getString(6), res.getString(7), res.getString(8), res.getString(9)});
            }
            for (int i = 0; i < this.tbl_logmasuk.getRowCount(); i++) {
                ...
                tbl.isCellEditable(i, 8);
                tbl.isCellEditable(i, 9);
            }
            tbl_logmasuk.setModel(tbl);
            this.caritbl = tbl;
        } catch (Exception e) {
            ...
            if (id.contains(key)) {
                ...
                tbl.addRow(
                        new Object[]{
                            ...
                            this.caritbl.getValueAt(i, 8),
                            this.caritbl.getValueAt(i, 9),}
                );
            }
        }

        this.tbl_logmasuk.setModel(tbl);
    }
    ...
    private void resetTableLpHarian() {
        ...
        TableColumnModel columnModel = this.tbl_logmasuk.getColumnModel();
        HeaderColumn1();
    }
    ...
    private void initComponents() {
        ...
        tbl_logmasuk = new javax.swing.JTable();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar_Menu/Frame Rentang Tanggal_1.png"))); // NOI18N
        panel_rentang.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 880, -1));
        ...
        tbl_logmasuk.setBackground(new java.awt.Color(0, 204, 204));
        tbl_logmasuk.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        tbl_logmasuk.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane2.setViewportView(tbl_logmasuk);

        panel_tbl_logmasuk.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 850, 460));
        ...
        labelutama.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar_Menu/Laporan Log Masuk.png"))); // NOI18N
    ...
    private void btn_tampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tampilActionPerformed
        ...
        String sql = "select * from Log_produkmasuk where Tanggal between '" + tanggalAwal + "' and '" + tanggalAkhir + "'";
        try {
            java.sql.Connection conn = (Connection) config.configDB();
            java.sql.Statement stm = conn.createStatement();
            ...
            while (hasil.next()) {
                ...
                String id_logmasuk = hasil.getString("Id_Logmasuk");
                String total = hasil.getString("Total_HargaSeluruh");
                String[] data = {"", tanggal, id_logmasuk, total};
                tabmode.addRow(data);
                noTable();
                jumlahData1();
    ...
    private void btn_cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cetakActionPerformed
        ...
        try {
            ...
            MessageFormat header = new MessageFormat("Laporan Log Masuk");
    ...
    private javax.swing.JTable tbl_logmasuk;
