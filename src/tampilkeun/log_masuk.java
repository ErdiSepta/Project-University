...
public final class log_masuk extends javax.swing.JFrame {
    ...
    public void id_auto() {
        try {
            ...
            String sql = "select max(right(Id_Logmasuk,4)) from log_produkmasuk";
            ResultSet res = stm.executeQuery(sql);
            while (res.next()) {
                if (res.first() == false) {
                    txt_idlog.setText("LOGM0001");
    ...
    public void HeaderColumn() {
        ...
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        table_utama.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        table_utama.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
        table_utama.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
        table_utama.getColumnModel().getColumn(4).setCellRenderer(centerRenderer);
        table_utama.getColumnModel().getColumn(6).setCellRenderer(centerRenderer);
        ((DefaultTableCellRenderer) table_utama.getTableHeader().getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);

        JTableHeader thead = table_utama.getTableHeader();
        thead.setForeground(Color.BLACK);
        thead.setFont(new Font("Tahome", Font.BOLD, 12));

        TableColumn column;
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(0);
        column.setPreferredWidth(91);
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(1);
        column.setPreferredWidth(84);
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(2);
        column.setPreferredWidth(80);
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(3);
        column.setPreferredWidth(169);
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(4);
        column.setPreferredWidth(66);
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(5);
        column.setPreferredWidth(182);
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(6);
        column.setPreferredWidth(58);   
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(7);
        column.setPreferredWidth(75);
        table_utama.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = table_utama.getColumnModel().getColumn(8);
        column.setPreferredWidth(84);
    }
    public void HeaderColumn1() {
        ...
        centerRenderer.setHorizontalAlignment(JLabel.CENTER);
        tbl_supp.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tbl_supp.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        ((DefaultTableCellRenderer) tbl_supp.getTableHeader().getDefaultRenderer()).setHorizontalAlignment(JLabel.CENTER);

        JTableHeader thead = tbl_supp.getTableHeader();
        thead.setForeground(Color.BLACK);
        thead.setFont(new Font("Tahome", Font.BOLD, 12));

        TableColumn column;
        tbl_supp.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_supp.getColumnModel().getColumn(0);
        column.setPreferredWidth(91);
        tbl_supp.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        column = tbl_supp.getColumnModel().getColumn(1);
    ...
    private void load_table() {
        ...
        try {
            ...
            while (res.next()) {
                model.addRow(new Object[]{res.getString(2), res.getString(3), res.getString(5), res.getString(7)});
            }
    ...
    private void load_table2() {
        ...
        this.tbl_supp.setModel(new javax.swing.table.DefaultTableModel(
                null,
                new String[]{
        ...
        DefaultTableModel model = (DefaultTableModel) this.tbl_supp.getModel();
        //menampilkan data database kedalam tabel
        try {
    ...
    public void JumlahkanBarang() {
        int jumlah, harga, total;

        jumlah = Integer.valueOf(txt_jml.getText());
        harga = Integer.valueOf(txt_hrgbeli.getText());
        total = jumlah * harga;
    ...
    private void initComponents() {
        ...
        tbl_listprd.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        tbl_listprd.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tbl_listprdKeyTyped(evt);
            }
        });
        jScrollPane2.setViewportView(tbl_listprd);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 330, 310, 120));

        tbl_supp.setBackground(new java.awt.Color(42, 171, 212));
        tbl_supp.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 170, 310, 90));
        ...
        jPanel1.add(txt_tgl, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 137, 200, 26));
        ...
        jPanel1.add(txt_idlog, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 172, 200, 26));
        ...
        jPanel1.add(txt_idsupp, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 205, 200, 26));

        txt_supp.setBackground(new java.awt.Color(42, 171, 212));
        txt_supp.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txt_supp.setForeground(new java.awt.Color(255, 255, 255));
        txt_supp.setBorder(null);
        jPanel1.add(txt_supp, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 240, 200, 24));
        ...
        jPanel1.add(txt_idprd, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 275, 200, 24));
        ...
        jPanel1.add(txt_namaprd, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 308, 200, 26));
        ...
        jPanel1.add(txt_jml, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 344, 30, 26));
        ...
        jPanel1.add(txt_hrgbeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 381, 90, 26));
        ...
        txt_totalhrg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_totalhrgActionPerformed(evt);
            }
        });
        jPanel1.add(txt_totalhrg, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 418, 90, 26));
        ...
        jPanel1.add(btn_hitung, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 380, 70, 30));
        ...
        jPanel1.add(btn_tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 140, 90, 40));
        ...
        jPanel1.add(btn_clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 240, 90, 40));
        ...
        table_utama.setBackground(new java.awt.Color(42, 171, 212));
        table_utama.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        table_utama.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Tanggal", "Id Log", "Id Supplier", "Nama Supplier", "Id Produk", "Nama Produk", "Jumlah", "Harga Beli", "Total Harga"
            }
        ));
        table_utama.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                table_utamaMouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(table_utama);

        jPanel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 520, 890, 140));
        ...
        jPanel1.add(btn_simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(728, 295, 90, 40));

        txtTotal.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        txtTotal.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(txtTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 670, 200, 24));
        ...
        jPanel1.add(txt_cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 299, 170, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar_Menu/Log Masuk.png"))); // NOI18N
    ...
    private void addrowtotabeldetail(Object[] dataRow) {
        DefaultTableModel model = (DefaultTableModel) table_utama.getModel();
        model.addRow(dataRow);
    }

    private void setrowtotabeldetail(Object[] dataRow) {
        DefaultTableModel model = (DefaultTableModel) table_utama.getModel();
        model.setValueAt(dataRow[0], table_utama.getRowCount() - 1, 0);
        model.setValueAt(dataRow[1], table_utama.getRowCount() - 1, 1);
        model.setValueAt(dataRow[2], table_utama.getRowCount() - 1, 2);
        model.setValueAt(dataRow[3], table_utama.getRowCount() - 1, 3);
        model.setValueAt(dataRow[4], table_utama.getRowCount() - 1, 4);
        model.setValueAt(dataRow[5], table_utama.getRowCount() - 1, 5);
        model.setValueAt(dataRow[6], table_utama.getRowCount() - 1, 6);
        model.setValueAt(dataRow[7], table_utama.getRowCount() - 1, 7);
        model.setValueAt(dataRow[8], table_utama.getRowCount() - 1, 8);
    }
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        if(this.txt_idsupp.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "Supplier tidak boleh kosong");
            return;
        }else if(this.txt_idprd.getText().isEmpty()){
        ...
        if (!error) {
            if (table_utama.getRowCount() >= 1) {
                String idProdukLama = table_utama.getValueAt(table_utama.getRowCount() - 1, 4).toString();
                stok = Integer.parseInt(table_utama.getValueAt(table_utama.getRowCount() - 1, 6).toString());
                ...
                if (idProdukLama.equals(idProdukBaru)) { //jika ada duplikasi 
                    tharga = table_utama.getValueAt(table_utama.getRowCount() - 1, 8).toString();
                    ...
                    setrowtotabeldetail(new Object[]{
                        ...
                        this.txt_idsupp.getText(),
                        this.txt_supp.getText(),
                        this.txt_idprd.getText(),
                        this.txt_namaprd.getText(),
                        stok2,
                        this.txt_hrgbeli.getText(),
                        tharga2,});
            ...
            for (int i = 0; i < table_utama.getRowCount(); i++) { //Menampilkan data total harga saat pertama 
                total = table_utama.getValueAt(i, 8).toString();
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        //TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel) table_utama.getModel();
        model.removeRow(table_utama.getSelectedRow());
    }//GEN-LAST:event_btn_hapusActionPerformed

    private void tbl_listprdKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbl_listprdKeyTyped
        // TODO add your handling code here:

    }//GEN-LAST:event_tbl_listprdKeyTyped
    ...
    private void tbl_suppMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_suppMouseClicked
        // TODO add your handling code here:
        int baris = tbl_supp.rowAtPoint(evt.getPoint());

        String IdSupplier = tbl_supp.getValueAt(baris, 0).toString();
        txt_idsupp.setText(IdSupplier);
        String NamaSupplier = tbl_supp.getValueAt(baris, 1).toString();
        txt_supp.setText(NamaSupplier);
    }//GEN-LAST:event_tbl_suppMouseClicked

    private void txt_totalhrgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_totalhrgActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_totalhrgActionPerformed
    private void hapus() {
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        try {
            ...
            if (table_utama.getRowCount() < 1) {           // or bla bla bla is empty, must be has data
                JOptionPane.showMessageDialog(rootPane, "Data belum lengkap");
            } else {
                java.sql.Connection conn = (Connection) config.configDB();
                String sql = "insert into  log_produkmasuk values (?,?,?)";
                ...
                String idSupplier, namaSupplier, idProduk, namaProduk, jumlah, hargaBeli, totalHarga;
                // Data ke 2

                for (int i = 0; i < table_utama.getRowCount(); i++) {
                    idSupplier = table_utama.getValueAt(i, 2).toString();
                    namaSupplier = table_utama.getValueAt(i, 3).toString();
                    idProduk = table_utama.getValueAt(i, 4).toString();
                    namaProduk = table_utama.getValueAt(i, 5).toString();
                    jumlah = table_utama.getValueAt(i, 6).toString();
                    hargaBeli = table_utama.getValueAt(i, 7).toString();
                    totalHarga = table_utama.getValueAt(i, 8).toString();
                    String sql1 = "insert into  detail_logprodukmasuk values (?,?,?,?,?,?,?,?)";
                    java.sql.PreparedStatement stat1 = conn.prepareStatement(sql1);
                    stat1.setString(1, txt_idlog.getText());
                    stat1.setString(2, idSupplier);
                    stat1.setString(3, namaSupplier);
                    stat1.setString(4, idProduk);
                    stat1.setString(5, namaProduk);
                    stat1.setString(6, jumlah);
                    stat1.setString(7, hargaBeli);
                    stat1.setString(8, totalHarga);
...
//                System.out.println("data 2 berhasil ditambahkan");
                ...
                load_table();
                DefaultTableModel model = (DefaultTableModel) table_utama.getModel();
                while (table_utama.getRowCount() > 0) {
                    model.removeRow(0);
                }
                kosong();
                id_auto();
    ...
    private void table_utamaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_utamaMouseClicked
        // TODO add your handling code here:
        int baris = table_utama.rowAtPoint(evt.getPoint());

        String Tanggal = table_utama.getValueAt(baris, 0).toString();
        txt_tgl.setText(Tanggal);
        String IdLog = table_utama.getValueAt(baris, 1).toString();
        txt_idlog.setText(IdLog);
        String IdSupp = table_utama.getValueAt(baris, 2).toString();
        txt_idsupp.setText(IdSupp);
        String NamaSupp = table_utama.getValueAt(baris, 3).toString();
        txt_supp.setText(NamaSupp);
        String IdProduk = table_utama.getValueAt(baris, 4).toString();
        txt_idprd.setText(IdProduk);
        String NamaProduk = table_utama.getValueAt(baris, 5).toString();
        txt_namaprd.setText(NamaProduk);
        String Jumlah = table_utama.getValueAt(baris, 6).toString();
        txt_jml.setText(Jumlah);
        String HargaBeli = table_utama.getValueAt(baris, 7).toString();
        txt_hrgbeli.setText(HargaBeli);
        String TotalHarga = table_utama.getValueAt(baris, 8).toString();
        txt_totalhrg.setText(TotalHarga);

    }//GEN-LAST:event_table_utamaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(log_masuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
